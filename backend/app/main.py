...
from app.integrations.payments.btcpay import BTCPayConfigurationError, BTCPayError
...
@app.exception_handler(BTCPayError)
@app.exception_handler(BTCPayConfigurationError)
async def _btcpay_error_handler(request: Request, exc: Exception) -> JSONResponse:
