...
export const EU_REVIEWS: EuReview[] = [
  ...
  {
    id: 'rev-2',
    title: 'Brimline is the real deal!',
    rating: 5,
  ...
  {
    id: 'rev-3',
    title: 'Excellent Experience with Brimline!',
    rating: 5,
    body: 'I recently used the Brimline website and had a surprisingly smooth experience from start to finish. The site is clean,',
    author: 'Kate Rick',
    date: 'May 26, 2026',
  },
  {
    id: 'rev-4',
    title: 'Reliable and Smooth Experience with Brimline',
    rating: 5,
    body: "I came across Brimline while looking for a dependable bulk supplier, and I'm glad I gave it a try. The whole process—from brow",
    author: 'Nathan Rings',
    date: 'April 6, 2026',
  ...
  },
  {
    ...
    rating: 5,
    body: "I've tried a few suppliers before, but Brimline genuinely stood out. From the start, the ordering process was quick and",
    author: 'Helen Ryans',
    date: 'April 1, 2026',
  },
  {
